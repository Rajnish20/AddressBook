        ...
        do {
            ...
            switch (option) {
                case 1:
                    ...
                    operations.addContacts(new Contact(firstName, lastName, city, state, pinCode, mobileNo, email));
                    break;
                case 2:
                    ...
                    operations.deleteContacts(fName, lName);
                    break;
                case 3:
                    ...
                    operations.updateContact(name1, name2, new Contact(newFirstName, newLastName, newCity, newState, newPinCode, newMobileNo, newEmail));
                    break;
                case 4:
